...
import com.mdd.constants.SecurityConstant;
...
public class AESCodeUtil {
    ...
    public static void main(String[] args) {
        ...
        String lon = "{\n" +
                ...
                "    \"version\":0\n" +
                "}";
        System.out.println(AESCodeUtil.encode(lon, "wmsapi0123456789"));
        // 返回数据解密
//        System.out.println(AESCodeUtil.decode("", "0123456789123456"));
    }
}
